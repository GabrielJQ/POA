...
class ImportarAperturaTiendas
{
    ...
    {
        $import = new AperturaTiendasMetaImport($anio, $this->almacenRepo, $this->conceptoRepo);
        ...
        return ['message' => 'Importación de apertura de tiendas completada.'];
    }
}
