...
class ImportarMermas
{
    ...
    {
        $import = new MermasQuebrantosImport($anio, $this->almacenRepo, $this->conceptoRepo);
        ...
        return ['message' => 'Importación de mermas y quebrantos completada.'];
    }
}
