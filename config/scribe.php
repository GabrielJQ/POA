...
return [
    ...
    'title' => 'POA - Documentación de Endpoints',

    'description' => 'Sistema de Programación Anual de Trabajo (POA) y Estado de Resultados. Documentación interna para el equipo de desarrollo.',

    'intro_text' => <<<'INTRO'
            Documentación de los endpoints del módulo POA.

            > Esta documentación es **exclusiva para el equipo de desarrollo**.
        INTRO,
    ...
    'laravel' => [
        ...
        'middleware' => [
            // Sin autenticación — acceso por URL directa (solo equipo de desarrollo conoce la ruta)
        ],
    ],
    ...
    'try_it_out' => [
        // Deshabilitado — documentación solo para consulta del equipo de desarrollo.
        'enabled' => false,
